...
const AboutSection = (props) => {
  ...
  return (
    <Section mobileTop>
      ...
      >
        I'm a Software Engineer proficient in ReactJS, Next.js, and
        Tailwind CSS. With expertise in JavaScript and Node.js, I craft seamless
        web experiences and responsive designs. Skilled in ML and Python, I
        ...
        development. Currently affiliated with techoverflows, I'm dedicated to
