        ...
        <div className="grid row-gap-10 lg:grid-cols-6 ">
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-3">
              ...
              <ul className="mt-2 space-y-2">
                ...
                <li>
                  <p className="">
                    E-mail:
                    <a
                      href="mailto:techoverflows@gmail.com"
                      className=" transition-colors duration-300 hover:text-deep-purple-accent-200"
                    >
                      {" "}
                      techoverflowsconnect@gmail.com
                    </a>
                  </p>
                </li>
                <li>
            ...
            <div>
              ...
              <div className="flex items-center mt-1 space-x-3">
                ...
                >
                  <a
                    to="https://instagram.com/techoverflows"
                    target="_blank"
                  >
                    <svg
                      viewBox="0 0 30 30"
                ...
                >
                  <a
                    to="https://youtube.com/@tech.overflows"
                    target="_blank"
                  >
                    <svg
                ...
                >
                  <a
                    to="https://www.facebook.com/profile.php?id=00000000000000"
                    target="_blank"
                  >
                    <svg
                      viewBox="0 0 24 24"
          ...
          <div className="mx-10 md:max-w-md lg:col-span-2">
            ...
            {/* <form
              ...
              // method="post"
              // action={`mailto:https://techoverflowsconnect@gmail.com?subject=Message from ${name}&body=${message}`}
